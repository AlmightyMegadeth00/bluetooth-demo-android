...
class AndroidBluetoothController(
    ...
    override fun startBluetoothServer(): Flow<ConnectionResult> {
        Log.e("AndroidBluetoothController", "startBluetoothServer")
        return flow {
            ...
            Log.e(TAG, "listening to service uuid: $SERVICE_UUID")
            ...
            while(shouldLoop) {
                currentClientSocket = try {
                    ...
                    Log.e(TAG, e.message ?: "null error")
                    shouldLoop = false
                    null
                }
    ...
    companion object {
        ...
        private val TAG = AndroidBluetoothController::class.java.simpleName
    }
}